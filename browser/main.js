...
var routes = [
  {
    path: "",
    loadComponent: () => import("./chunk-5FNQUBNE.js").then((m) => m.HomeComponent)
  },
  { path: "**", redirectTo: "" }
];
...
var _forTrack0 = ($index, $item) => $item.sectionId;
function NavbarComponent_For_9_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "li")(1, "a", 13);
    \u0275\u0275listener("click", function NavbarComponent_For_9_Template_a_click_1_listener() {
      \u0275\u0275restoreView(_r1);
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275classProp("nav-link--active", ctx_r1.isActive(link_r3.sectionId));
    \u0275\u0275property("href", link_r3.href, \u0275\u0275sanitizeUrl);
    \u0275\u0275attribute("aria-current", ctx_r1.isActive(link_r3.sectionId) ? "true" : null);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", link_r3.label, " ");
  }
}
function NavbarComponent_For_20_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "li")(1, "a", 14);
    \u0275\u0275listener("click", function NavbarComponent_For_20_Template_a_click_1_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.closeMobileMenu());
    });
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275classProp("nav-mobile__link--active", ctx_r1.isActive(link_r5.sectionId));
...
var NavbarComponent = class _NavbarComponent {
  constructor() {
    ...
    this.activeSection = signal("home-section");
  ...
  static {
    ...
    }, standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 25, vars: 7, consts: [["role", "navigation", "aria-label", "Main navigation", 1, "navbar", 3, "ngClass"], [1, "nav-container"], ["href", "#home-section", "aria-label", "Rohini Gaikwad - Home", 1, "nav-brand"], ["aria-hidden", "true", 1, "nav-brand__initials"], [1, "nav-brand__name"], ["role", "list", 1, "nav-links"], ["href", "assets/Rohini_Gaikwad_Angular_React_Developer.pdf.pdf", "target", "_blank", "rel", "noopener noreferrer", "download", "", "aria-label", "Download Rohini's resume PDF", 1, "nav-cta", "btn", "btn-primary", "hide-mobile"], ["aria-hidden", "true", 1, "fas", "fa-download"], ["aria-controls", "mobile-menu", "aria-label", "Toggle navigation menu", 1, "nav-toggle", 3, "click"], [1, "nav-toggle__bar"], ["id", "mobile-menu", "role", "dialog", 1, "nav-mobile"], ["role", "list"], ["href", "assets/Rohini_Gaikwad_Angular_React_Developer.pdf.pdf", "target", "_blank", "download", "", 1, "btn", "btn-primary", 2, "margin-top", "0.5rem"], [1, "nav-link", 3, "click", "href"], [1, "nav-mobile__link", 3, "click", "href"]], template: function NavbarComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "nav", 0)(1, "div", 1)(2, "a", 2)(3, "span", 3);
        \u0275\u0275text(4, "RG");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(5, "span", 4);
        \u0275\u0275text(6, "Rohini Gaikwad");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(7, "ul", 5);
        \u0275\u0275repeaterCreate(8, NavbarComponent_For_9_Template, 3, 5, "li", null, _forTrack0);
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275element(14, "span", 9)(15, "span", 9)(16, "span", 9);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(17, "div", 10)(18, "ul", 11);
        \u0275\u0275repeaterCreate(19, NavbarComponent_For_20_Template, 3, 4, "li", null, _forTrack0);
        \u0275\u0275elementStart(21, "li")(22, "a", 12);
        \u0275\u0275element(23, "i", 7);
        \u0275\u0275text(24, " Download Resume ");
        \u0275\u0275elementEnd()()()()();
      }
      if (rf & 2) {
        \u0275\u0275property("ngClass", ctx.navClasses());
        \u0275\u0275advance(8);
        \u0275\u0275repeater(ctx.navLinks);
        \u0275\u0275advance(5);
        \u0275\u0275classProp("nav-toggle--open", ctx.isMobileOpen());
        \u0275\u0275attribute("aria-expanded", ctx.isMobileOpen());
        \u0275\u0275advance(4);
        \u0275\u0275classProp("nav-mobile--open", ctx.isMobileOpen());
        \u0275\u0275attribute("aria-hidden", !ctx.isMobileOpen());
        \u0275\u0275advance(2);
        \u0275\u0275repeater(ctx.navLinks);
      }
    }, dependencies: [NgClass], styles: ['\n\n.navbar[_ngcontent-%COMP%] {\n  position: fixed;\n  top: 0;\n  left: 0;\n  right: 0;\n  z-index: 1000;\n  height: var(--nav-height);\n  background: transparent;\n  transition:\n    background var(--transition),\n    border-color var(--transition),\n    box-shadow var(--transition);\n  border-bottom: 1px solid transparent;\n}\n.navbar.nav--scrolled[_ngcontent-%COMP%] {\n  background: rgba(13, 13, 15, 0.88);\n  backdrop-filter: blur(20px);\n  -webkit-backdrop-filter: blur(20px);\n  border-bottom-color: var(--color-border);\n  box-shadow: 0 1px 0 var(--color-border);\n}\n.nav-container[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 1.5rem;\n  height: 100%;\n  max-width: var(--container-max);\n  margin: 0 auto;\n  padding: 0 1.5rem;\n}\n.nav-brand[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 0.625rem;\n  text-decoration: none;\n  flex-shrink: 0;\n}\n.nav-brand__initials[_ngcontent-%COMP%] {\n  width: 34px;\n  height: 34px;\n  background: var(--color-accent);\n  color: #0d0d0f;\n  border-radius: var(--radius-sm);\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  font-family: var(--font-display);\n  font-weight: 800;\n  font-size: 0.8125rem;\n  letter-spacing: 0.02em;\n  flex-shrink: 0;\n  transition: transform var(--transition);\n}\n.nav-brand[_ngcontent-%COMP%]:hover   .nav-brand__initials[_ngcontent-%COMP%] {\n  transform: rotate(-6deg);\n}\n.nav-brand__name[_ngcontent-%COMP%] {\n  font-family: var(--font-display);\n  font-weight: 700;\n  font-size: 1rem;\n  color: var(--color-text-primary);\n  transition: color var(--transition);\n}\n.nav-brand[_ngcontent-%COMP%]:hover   .nav-brand__name[_ngcontent-%COMP%] {\n  color: var(--color-accent);\n}\n.nav-links[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 0;\n  list-style: none;\n  margin: 0;\n  padding: 0;\n  margin-left: auto;\n}\n.nav-link[_ngcontent-%COMP%] {\n  position: relative;\n  font-size: 0.9rem;\n  font-weight: 500;\n  color: var(--color-text-secondary);\n  padding: 0.5rem 0.875rem;\n  border-radius: var(--radius-sm);\n  text-decoration: none;\n  transition: color var(--transition), background var(--transition);\n  letter-spacing: 0.01em;\n}\n.nav-link[_ngcontent-%COMP%]:hover {\n  color: var(--color-text-primary);\n  background: rgba(255, 255, 255, 0.04);\n}\n.nav-link--active[_ngcontent-%COMP%] {\n  color: var(--color-accent) !important;\n}\n.nav-link--active[_ngcontent-%COMP%]::after {\n  content: "";\n  position: absolute;\n  bottom: -1px;\n  left: 0.875rem;\n  right: 0.875rem;\n  height: 2px;\n  background: var(--color-accent);\n  border-radius: 1px;\n}\n.nav-cta[_ngcontent-%COMP%] {\n  margin-left: 0.75rem;\n  flex-shrink: 0;\n  font-size: 0.875rem;\n  padding: 0.5rem 1.25rem;\n}\n.nav-toggle[_ngcontent-%COMP%] {\n  display: none;\n  flex-direction: column;\n  justify-content: center;\n  gap: 5px;\n  width: 40px;\n  height: 40px;\n  background: transparent;\n  border: 1px solid var(--color-border);\n  cursor: pointer;\n  padding: 8px;\n  border-radius: var(--radius-sm);\n  margin-left: auto;\n  transition: border-color var(--transition);\n}\n.nav-toggle[_ngcontent-%COMP%]:hover {\n  border-color: var(--color-border-hover);\n}\n.nav-toggle__bar[_ngcontent-%COMP%] {\n  display: block;\n  width: 20px;\n  height: 1.5px;\n  background: var(--color-text-primary);\n  border-radius: 1px;\n  transition: all var(--transition);\n}\n.nav-toggle--open[_ngcontent-%COMP%]   .nav-toggle__bar[_ngcontent-%COMP%]:nth-child(1) {\n  transform: translateY(6.5px) rotate(45deg);\n}\n.nav-toggle--open[_ngcontent-%COMP%]   .nav-toggle__bar[_ngcontent-%COMP%]:nth-child(2) {\n  opacity: 0;\n  transform: scaleX(0);\n}\n.nav-toggle--open[_ngcontent-%COMP%]   .nav-toggle__bar[_ngcontent-%COMP%]:nth-child(3) {\n  transform: translateY(-6.5px) rotate(-45deg);\n}\n.nav-mobile[_ngcontent-%COMP%] {\n  display: none;\n  position: fixed;\n  top: var(--nav-height);\n  left: 0;\n  right: 0;\n  z-index: 999;\n  padding: 1rem 1.5rem 1.5rem;\n  background: rgba(13, 13, 15, 0.97);\n  backdrop-filter: blur(20px);\n  border-top: 1px solid var(--color-border);\n  transform: translateY(-8px);\n  opacity: 0;\n  transition: transform 220ms ease, opacity 220ms ease;\n}\n.nav-mobile[_ngcontent-%COMP%]   ul[_ngcontent-%COMP%] {\n  list-style: none;\n  display: flex;\n  flex-direction: column;\n  gap: 2px;\n}\n.nav-mobile__link[_ngcontent-%COMP%] {\n  display: block;\n  padding: 0.75rem 1rem;\n  font-size: 1rem;\n  font-weight: 500;\n  color: var(--color-text-secondary);\n  text-decoration: none;\n  border-radius: var(--radius-sm);\n  transition: all var(--transition);\n}\n.nav-mobile__link[_ngcontent-%COMP%]:hover, \n.nav-mobile__link--active[_ngcontent-%COMP%] {\n  color: var(--color-accent);\n  background: var(--color-accent-glow);\n}\n@media (max-width: 900px) {\n  .nav-links[_ngcontent-%COMP%], \n   .nav-cta.hide-mobile[_ngcontent-%COMP%] {\n    display: none;\n  }\n  .nav-toggle[_ngcontent-%COMP%] {\n    display: flex;\n  }\n  .nav-mobile.nav-mobile--open[_ngcontent-%COMP%] {\n    display: block;\n    transform: translateY(0);\n    opacity: 1;\n  }\n}\n/*# sourceMappingURL=navbar.component.css.map */'] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NavbarComponent, { className: "NavbarComponent", filePath: "src\\app\\navbar\\navbar.component.ts", lineNumber: 15 });
})();
...
var AppComponent = class _AppComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppComponent, selectors: [["app-root"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 14, vars: 1, consts: [["href", "#main-content", 1, "skip-link"], ["id", "main-content"], ["role", "contentinfo", 1, "site-footer"], [1, "container", "site-footer__content"], [1, "site-footer__links"], ["href", "https://github.com/rohinigaikwad7057", "target", "_blank", "rel", "noopener noreferrer", "aria-label", "GitHub profile"], ["aria-hidden", "true", 1, "fab", "fa-github"], ["href", "https://www.linkedin.com/in/rohini-gaikwad7057/", "target", "_blank", "rel", "noopener noreferrer", "aria-label", "LinkedIn profile"], ["aria-hidden", "true", 1, "fab", "fa-linkedin"]], template: function AppComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "a", 0);
        \u0275\u0275text(1, "Skip to main content");
        \u0275\u0275elementEnd();
        \u0275\u0275element(2, "app-navbar");
        \u0275\u0275elementStart(3, "main", 1);
        \u0275\u0275element(4, "router-outlet");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(5, "footer", 2)(6, "div", 3)(7, "span");
        \u0275\u0275text(8);
        \u0275\u0275elementEnd();
      ...
      if (rf & 2) {
        \u0275\u0275advance(8);
        \u0275\u0275textInterpolate1("\xA9 ", ctx.currentYear, " Rohini Gaikwad. Built with Angular 18.");
      }
